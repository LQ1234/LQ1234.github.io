...
window.addEventListener('load',function() {
  ...
  var particles = parseInt($("#noOfParticles")[0].value);
  ...
  $("#import").click(function(){
     particles = parseInt($("#noOfParticles")[0].value);
     intersectionTimes = new Float32Array(particles);
     intersectionLine = new Float32Array(particles);
    particlePV = new Float32Array(particles * 4);
    particleT = new Float32Array(particles);
